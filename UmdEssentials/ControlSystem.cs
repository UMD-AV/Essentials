...
using UmdEssentials.Core.Touchpanels;
...
namespace UmdEssentials
{
    public class ControlSystem : CrestronControlSystem
    {
        ...
        private void StartSystem(object preventInitialization)
        {
            ...
            if (!(bool)preventInitialization) SystemMonitor.ProgramInitialization.ProgramInitializationComplete = true;
        }
        ...
        private void Reload()
        {
            ...
            {
                if (newDev.Key.StartsWith("processor")) continue;
                ...
                if (oldDev != null)
                {
                    ...
                    if (newDevString == oldDevString) continue;
        ...
        private void LoadNonProcessorDevice(DeviceConfig devConf)
        {
            ...
            IKeyed newDev = Core.DeviceFactory.GetDevice(devConf);
        ...
        private void LoadDevices()
        {
            ...
            string bridges = Encoding.GetEncoding(28591).GetString(Properties.Resources.umdBridges,
                0, Properties.Resources.umdBridges.Length);
            ...
            foreach (DeviceConfig devConf in BridgesObject.Devices)
                ...
                {
                    // Try local factories first
                    IKeyed newDev = null ?? Core.DeviceFactory.GetDevice(devConf);

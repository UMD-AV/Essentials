...
namespace PepperDash.Core.JsonStandardObjects
{
    ...
    */
    ...
    public class ComParamsConfig
    {
        ...
        public ushort simplBaudRate
        {
            get { return Convert.ToUInt16(baudRate); }
        }

        public ushort simplDataBits
        {
            get { return Convert.ToUInt16(dataBits); }
        }

        public ushort simplStopBits
        {
            get { return Convert.ToUInt16(stopBits); }
        }

        public ushort simplPacing
        {
            get { return Convert.ToUInt16(pacing); }
        }
    ...
    public class TcpSshPropertiesConfig
    {
        ...
        // convert properties for simpl
        public ushort simplPort
        {
            get { return Convert.ToUInt16(port); }
        }

        public ushort simplAutoReconnect
        {
            get { return (ushort)(autoReconnect ? 1 : 0); }
        }

        public ushort simplAutoReconnectIntervalMs
        {
            get { return Convert.ToUInt16(autoReconnectIntervalMs); }
        }
    ...
    public class ControlConfig
    {
        ...
        // convert properties for simpl
        public ushort simplControlPortNumber
        {
            get { return Convert.ToUInt16(controlPortNumber); }
        }
    ...
    public class PropertiesConfig
    {
        ...
        // convert properties for simpl
        public ushort simplDeviceId
        {
            get { return Convert.ToUInt16(deviceId); }
        }

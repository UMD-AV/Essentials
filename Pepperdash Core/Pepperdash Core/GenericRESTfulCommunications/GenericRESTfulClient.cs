    ...
    public class GenericRESTfulClient
    {
        ...
        private string EncodeBase64(string username, string password)
        {
            ...
            try
            {
                if (!string.IsNullOrEmpty(username))
                {
                    string base64String = System.Convert.ToBase64String(System.Text.Encoding.GetEncoding("ISO-8859-1")
            ...
            {
                string msg = string.Format("EncodeBase64({0}, {1}) failed:\r{2}", username, password, e);
                CrestronConsole.PrintLine(msg);
                ErrorLog.Error(msg);
                return "";
            }

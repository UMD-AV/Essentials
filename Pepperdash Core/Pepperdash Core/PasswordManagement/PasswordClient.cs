...
namespace PepperDash.Core.PasswordManagement
{
    public class PasswordClient
    {
        ...
        public void Initialize()
        {
            ...
            OnUshrtChange((ushort)PasswordManager.Passwords.Count, 0,
                PasswordManagementConstants.PasswordManagerCountChange);
        ...
        public void GetPasswordByIndex(ushort key)
        {
            ...
            string pw = PasswordManager.Passwords[Key];
            if (pw == null)
            {
        ...
        public void BuildPassword(string data)
        {
            ...
            OnBoolChange(true, (ushort)PasswordToValidate.Length,
                PasswordManagementConstants.PasswordLedFeedbackChange);
        ...
        {
            PasswordToValidate = "";
            OnBoolChange(false, (ushort)PasswordToValidate.Length,
                PasswordManagementConstants.PasswordLedFeedbackChange);
        }

    ...
    public class GenericSecureTcpIpClient_ForServer : Device, IAutoReconnect
    {
        ...
        public void Initialize(TcpClientConfigObject clientConfigObject)
        {
            try
            {
                ...
                {
                    TcpSshPropertiesConfig TcpSshProperties = clientConfigObject.Control.TcpSshProperties;
                    ...
                    AutoReconnectIntervalMs = TcpSshProperties.AutoReconnectIntervalMs > 1000
                        ? TcpSshProperties.AutoReconnectIntervalMs
                        : 5000;
                    ...
                    HeartbeatRequiredIntervalInSeconds = clientConfigObject.HeartbeatRequiredIntervalInSeconds > 0
                        ? clientConfigObject.HeartbeatRequiredIntervalInSeconds
                        : (ushort)15;
                    HeartbeatString = string.IsNullOrEmpty(clientConfigObject.HeartbeatStringToMatch)
                        ? "heartbeat"
                        : clientConfigObject.HeartbeatStringToMatch;
                    Port = TcpSshProperties.Port;
                    BufferSize = TcpSshProperties.BufferSize > 2000 ? TcpSshProperties.BufferSize : 2000;
                    ReceiveQueueSize = clientConfigObject.ReceiveQueueSize > 20
                        ? clientConfigObject.ReceiveQueueSize
                        : 20;

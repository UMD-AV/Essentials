...
namespace PepperDash.Core.SystemInfo
{
    ...
    public class SystemInfoToSimpl
    {
        ...
        public void GetProcessorInfo()
        {
            ...
            {
                string msg = string.Format("GetProcessorInfo failed: {0}", e.Message);
        ...
        public void GetEthernetInfo()
        {
            ...
            EthernetInfo adapter = new EthernetInfo();
            ...
            try
            {
                ...
                string dhcpState = CrestronEthernetHelper.GetEthernetParameter(
                    CrestronEthernetHelper.ETHERNET_PARAMETER_TO_GET.GET_CURRENT_DHCP_STATE, adapterId);
                ...
                adapter.MacAddress =
                    CrestronEthernetHelper.GetEthernetParameter(
                        CrestronEthernetHelper.ETHERNET_PARAMETER_TO_GET.GET_MAC_ADDRESS, adapterId);
                adapter.IpAddress = CrestronEthernetHelper.GetEthernetParameter(
                ...
                adapter.Gateway =
                    CrestronEthernetHelper.GetEthernetParameter(
                        CrestronEthernetHelper.ETHERNET_PARAMETER_TO_GET.GET_CURRENT_ROUTER, adapterId);
                adapter.Domain =
                    CrestronEthernetHelper.GetEthernetParameter(
                ...
                string dns =
                    CrestronEthernetHelper.GetEthernetParameter(
                        CrestronEthernetHelper.ETHERNET_PARAMETER_TO_GET.GET_DNS_SERVER, adapterId);
                if (dns.Contains(","))
                {
            ...
            {
                string msg = string.Format("GetEthernetInfo failed: {0}", e.Message);
                CrestronConsole.PrintLine(msg);
                //ErrorLog.Error(msg);
            }
        ...
        public void GetControlSubnetInfo()
        {
            ...
            ControlSubnetInfo adapter = new ControlSubnetInfo();
            ...
            try
            {
                ...
                if (!adapterId.Equals(EthernetAdapterType.EthernetUnknownAdapter))
                {
                    ...
                    adapter.IpAddress = CrestronEthernetHelper.GetEthernetParameter(
                        CrestronEthernetHelper.ETHERNET_PARAMETER_TO_GET.GET_CURRENT_IP_ADDRESS, adapterId);
                    adapter.Subnet = CrestronEthernetHelper.GetEthernetParameter(
                        CrestronEthernetHelper.ETHERNET_PARAMETER_TO_GET.GET_CURRENT_IP_MASK, adapterId);
            ...
            catch (Exception e)
            {
                ...
                string msg = string.Format("GetControlSubnetInfo failed: {0}", e.Message);
                CrestronConsole.PrintLine(msg);
                //ErrorLog.Error(msg);
            }
        ...
        public void GetProgramInfoByIndex(ushort index)
        {
            ...
            {
                string msg = string.Format("GetProgramInfoByIndex failed: {0}", e.Message);
                CrestronConsole.PrintLine(msg);
                //ErrorLog.Error(msg);
            }
        ...
        public void RefreshProcessorUptime()
        {
            ...
            {
                string msg = string.Format("RefreshProcessorUptime failed:\r{0}", e.Message);
                CrestronConsole.PrintLine(msg);
                //ErrorLog.Error(msg);
            }
        }
        ...
        public void RefreshProgramUptimeByIndex(int index)
        {
            ...
            {
                string msg = string.Format("RefreshProgramUptimebyIndex({0}) failed:\r{1}", index, e.Message);
                CrestronConsole.PrintLine(msg);
                //ErrorLog.Error(msg);
            }
        }
        ...
        private string ParseConsoleResponse(string data, string line, string dataStart, string dataEnd)
        {
            ...
            if (string.IsNullOrEmpty(data) || string.IsNullOrEmpty(line) || string.IsNullOrEmpty(dataStart) ||
                string.IsNullOrEmpty(dataEnd))
                return response;
            ...
            {
                string msg = string.Format("ParseConsoleResponse failed: {0}", e.Message);
                CrestronConsole.PrintLine(msg);
                //ErrorLog.Error(msg);
            }
        ...
        {
            EventHandler<ProcessorChangeEventArgs> handler = ProcessorChange;
            if (handler != null)
            {
        ...
        {
            EventHandler<EthernetChangeEventArgs> handler = EthernetChange;
            if (handler != null)
            {
        ...
        {
            EventHandler<ControlSubnetChangeEventArgs> handler = ControlSubnetChange;
            if (handler != null)
            {
        ...
        {
            EventHandler<ProgramChangeEventArgs> handler = ProgramChange;

...
namespace PepperDash.Essentials.Core
{
    ...
    public class ComSpecJsonConverter : JsonConverter
    {
            ...
            JsonSerializer serializer)
        {
            ...
            {
                JsonSerializer newSer = new JsonSerializer();
    ...
    public class ComSpecPropsJsonConverter : JsonConverter
    {
            ...
            JsonSerializer serializer)
        {
            ...
            if (objectType == typeof(ComPort.eComBaudRates))
                ...
                return Enum.Parse(typeof(ComPort.eComHardwareHandshakeType), "ComspecHardwareHandshake" + reader.Value,
                    true);
                ...
                return Enum.Parse(typeof(ComPort.eComSoftwareHandshakeType), "ComspecSoftwareHandshake" + reader.Value,
                    true);

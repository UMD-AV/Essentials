...
namespace PepperDash.Essentials.Core
{
    ...
    /// 
    /// </summary>
    public abstract class DisplayBase : EssentialsDevice, IHasFeedback, IRoutingSinkWithSwitching, IHasPowerControl,
        IWarmingCooling, IUsageTracking
    {
        ...
        protected void LinkDisplayToApi(DisplayBase displayDevice, BasicTriList trilist, uint joinStart,
            string joinMapKey,
        ...
        protected void LinkDisplayToApi(DisplayBase displayDevice, BasicTriList trilist,
            DisplayControllerJoinMap joinMap)
        {
            ...
            IntFeedback inputNumberFeedback = new IntFeedback(() => inputNumber);

            // Two way feedbacks
            TwoWayDisplayBase twoWayDisplay = displayDevice as TwoWayDisplayBase;

            if (twoWayDisplay != null)
            {
                trilist.SetBool(joinMap.IsTwoWayDisplay.JoinNumber, true);

                twoWayDisplay.CurrentInputFeedback.OutputChange += (o, a) =>
                    Debug.Console(1, "CurrentInputFeedback_OutputChange {0}", a.StringValue);
            ...
            TwoWayDisplayBase twoWayDisplayDevice = displayDevice as TwoWayDisplayBase;
            if (twoWayDisplayDevice != null)
            {
                ...
                twoWayDisplayDevice.PowerIsOnFeedback.LinkComplementInputSig(
            ...
            for (int i = 0; i < displayDevice.InputPorts.Count; i++)
            {
                if (i < joinMap.InputNamesOffset.JoinSpan)
                {
                    ...
                    string tempKey = inputKeys.ElementAt(i);
            ...
            IBasicVolumeControls volumeDisplay = displayDevice as IBasicVolumeControls;
            ...
            IBasicVolumeWithFeedback volumeDisplayWithFeedback = volumeDisplay as IBasicVolumeWithFeedback;
            ...
            volumeDisplayWithFeedback.MuteFeedback.LinkComplementInputSig(

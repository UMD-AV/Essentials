...
namespace PepperDash.Essentials.Core
{
    ...
    public class BasicIrDisplay : DisplayBase, IBasicVolumeControls, IBridgeAdvanced
    {
        ...
        public override void ExecuteSwitch(object inputSelector)
        {
            ...
            Action finishSwitch = () =>
            {
                Action action = inputSelector as Action;
                if (action != null)
                    action();
            };
    ...
    public class BasicIrDisplayFactory : EssentialsDeviceFactory<BasicIrDisplay>
    {
        ...
        public override EssentialsDevice BuildDevice(DeviceConfig dc)
        {
            ...
            IrOutPortConfig ir = IRPortHelper.GetIrPort(dc.Properties);
            if (ir != null)
            {
                BasicIrDisplay display = new BasicIrDisplay(dc.Key, dc.Name, ir.Port, ir.FileName);

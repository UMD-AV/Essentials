...
namespace PepperDash.Essentials.Core
{
    ...
    public class GlsOdtOccupancySensorController : GlsOccupancySensorBaseController
    {
            ...
            : base(key, config.Name, config)
        {
            AddPreActivationAction(() =>
            {
                ...
                UltrasonicSensitivityInVacantStateFeedback =
                    new IntFeedback(() => _occSensor.UsSensitivityInVacantStateFeedback.UShortValue);

                UltrasonicSensitivityInOccupiedStateFeedback =
                    new IntFeedback(() => _occSensor.UsSensitivityInOccupiedStateFeedback.UShortValue);
            });
        }
        ...
        protected override void OccSensor_GlsOccupancySensorChange(GlsOccupancySensorBase device,
        ...
        /// <param name="device"></param>
        /// <param name="args"></param>
        protected override void OccSensor_BaseEvent(Crestron.SimplSharpPro.GenericBase device,

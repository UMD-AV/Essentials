...
namespace PepperDash.Essentials.Core
{
    ...
    [ConfigSnippet(
        "\"properties\": {\"control\": {\"method\": \"cresnet\",\"cresnetId\": \"97\"},\"enablePir\": true,\"enableLedFlash\": true,\"enableRawStates\":true,\"remoteTimeout\": 30,\"internalPhotoSensorMinChange\": 0,\"externalPhotoSensorMinChange\": 0}")]
    public abstract class GlsOccupancySensorBaseController : CrestronGenericBridgeableBaseDevice,
        IOccupancyStatusProvider
    {
        ...
        protected virtual void OccSensor_GlsOccupancySensorChange(GlsOccupancySensorBase device,
            GlsOccupancySensorChangeEventArgs args)
        {
            switch (args.EventId)
            {
        ...
        {
            GlsOccupancySensorBaseJoinMap joinMap = new GlsOccupancySensorBaseJoinMap(joinStart);
        ...
        private static void LinkDualTechSensorToApi(GlsOccupancySensorBaseController occController,
            ...
            GlsOccupancySensorBaseJoinMap joinMap)
        {
            ...
            odtOccController.AndWhenVacatedFeedback.LinkInputSig(
                trilist.BooleanInput[joinMap.AndWhenVacated.JoinNumber]);
            ...
            odtOccController.UltrasonicAEnabledFeedback.LinkInputSig(
                trilist.BooleanInput[joinMap.EnableUsA.JoinNumber]);
            ...
            odtOccController.UltrasonicBEnabledFeedback.LinkInputSig(
                trilist.BooleanInput[joinMap.EnableUsB.JoinNumber]);
            ...
            odtOccController.RawOccupancyUsFeedback.LinkInputSig(
                trilist.BooleanInput[joinMap.RawOccupancyUsFeedback.JoinNumber]);
        }

        private static void LinkSingleTechSensorToApi(GlsOccupancySensorBaseController occController,
            BasicTriList trilist,
            GlsOccupancySensorBaseJoinMap joinMap)
        {
// Occupied status
            ...
            occController.LocalTimoutFeedback.LinkInputSig(
            ...
            trilist.SetSigTrueAction(joinMap.EnableShortTimeout.JoinNumber,
                () => occController.SetShortTimeoutState(true));
            trilist.SetSigTrueAction(joinMap.DisableShortTimeout.JoinNumber,
                () => occController.SetShortTimeoutState(false));

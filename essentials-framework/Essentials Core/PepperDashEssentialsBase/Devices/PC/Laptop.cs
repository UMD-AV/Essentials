...
namespace PepperDash.Essentials.Core.Devices
{
    ...
    /// </summary>
    public class Laptop : EssentialsDevice, IHasFeedback, IRoutingOutputs, IAttachVideoStatus, IUiDisplayInfo,
        IUsageTracking
    {
        public uint DisplayUiType
        {
            get { return DisplayUiConstants.TypeLaptop; }
        }
            ...
            : base(key, name)
        {
            ...
            OutputPorts.Add(AnyVideoOut = new RoutingOutputPort(RoutingPortNames.AnyOut,
        ...
        public FeedbackCollection<Feedback> Feedbacks
        {
            get
            {
                FeedbackCollection<Feedback> newList = new FeedbackCollection<Feedback>();

...
namespace PepperDash.Essentials.Core
{
    ...
    public class IrOutputPortController : Device
    {
        ...
        public string[] IrFileCommands
        {
            get { return IrPort.AvailableStandardIRCmds(IrPortUid); }
        }
            ...
            : base(key)
        {
            ...
            AddPostActivationAction(() =>
            {
                ...
                string filePath = Global.FilePathPrefix + "ir" + Global.DirectorySeparator +
                                  config.Properties["control"]["irFile"].Value<string>();
        ...
        public void LoadDriver(string path)
        {
            ...
            catch
            {
                ...
                string message = string.Format("WARNING IR Driver '{0}' failed to load", path);

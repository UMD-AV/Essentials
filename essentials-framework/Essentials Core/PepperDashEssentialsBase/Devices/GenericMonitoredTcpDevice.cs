    ...
    public class GenericCommunicationMonitoredDevice : Device, ICommunicationMonitor
    {
            ...
            : base(key, name)
        {
            ...
            CommunicationMonitor =
                new GenericCommunicationMonitor(this, Client, pollTime, warningTime, errorTime, pollString);
        ...
        /// </summary>
        [Obsolete]
        public GenericCommunicationMonitoredDevice(string key, string name, string hostname, int port,
            string pollString)

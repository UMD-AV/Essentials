...
namespace PepperDash.Essentials.Core
{
    ...
    {
        [JsonProperty("sourceKey")] public string SourceKey { get; set; }
        ...
        [JsonProperty("destinations")] public List<eSourceListItemDestinationTypes> Destinations { get; set; }
    ...
    public class SourceRouteListItem
    {
        ...
        [JsonProperty("destinationKey")] public string DestinationKey { get; set; }

        [JsonProperty("type")] public eRoutingSignalType Type { get; set; }
    }

...
namespace PepperDash.Essentials.Core.Config
{
    ...
    public class InfoConfig
    {
        ...
        [JsonProperty("runtimeInfo")] public RuntimeInfo RuntimeInfo { get; set; }

        [JsonProperty("comment")] public string Comment { get; set; }

        [JsonProperty("hostname")] public string HostName { get; set; }

        [JsonProperty("appNumber")] public uint AppNumber { get; set; }
        ...
        public InfoConfig()
        {
            ...
            Version = "";
            Comment = "";
            HostName = CrestronEthernetHelper.GetEthernetParameter(
    ...
    public class RuntimeInfo
    {
        ...
        {
            get { return Global.EthernetAdapterInfoCollection; }
        }
    }
}
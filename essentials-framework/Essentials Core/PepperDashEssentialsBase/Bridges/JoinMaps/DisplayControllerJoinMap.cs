...
namespace PepperDash.Essentials.Core.Bridges
{
    public class DisplayControllerJoinMap : JoinMapBaseAdvanced
    {
        ...
        [JoinName("IsTwoWayDisplay")] public JoinDataComplete IsTwoWayDisplay = new JoinDataComplete(
            new JoinData { JoinNumber = 3, JoinSpan = 1 },
            new JoinMetadata
            {
                Description = "Is Two Way Display", JoinCapabilities = eJoinCapabilities.ToSIMPL,
                JoinType = eJoinType.Digital
            });

        [JoinName("DefaultVolume")] public JoinDataComplete DefaultVolume = new JoinDataComplete(
            new JoinData { JoinNumber = 4, JoinSpan = 1 },
            new JoinMetadata
            {
                Description = "Default Volume", JoinCapabilities = eJoinCapabilities.FromSIMPL,
                JoinType = eJoinType.Digital
            });
        ...
        [JoinName("VolumeUp")] public JoinDataComplete VolumeUp = new JoinDataComplete(
            ...
            new JoinMetadata
            {
                Description = "Volume Up", JoinCapabilities = eJoinCapabilities.FromSIMPL, JoinType = eJoinType.Digital
            });
        ...
        [JoinName("VolumeLevel")] public JoinDataComplete VolumeLevel = new JoinDataComplete(
            ...
            new JoinMetadata
            {
                Description = "Volume Level", JoinCapabilities = eJoinCapabilities.ToFromSIMPL,
        ...
        [JoinName("VolumeDown")] public JoinDataComplete VolumeDown = new JoinDataComplete(
            ...
            new JoinMetadata
            {
                Description = "Volume Down", JoinCapabilities = eJoinCapabilities.FromSIMPL,
                JoinType = eJoinType.Digital
            });

        [JoinName("VolumeMute")] public JoinDataComplete VolumeMute = new JoinDataComplete(
            new JoinData { JoinNumber = 7, JoinSpan = 1 },
            new JoinMetadata
            {
                Description = "Volume Mute", JoinCapabilities = eJoinCapabilities.ToFromSIMPL,
                JoinType = eJoinType.Digital
            });
        ...
        [JoinName("VolumeMuteOn")] public JoinDataComplete VolumeMuteOn = new JoinDataComplete(
            ...
            new JoinMetadata
            {
                Description = "Volume Mute On", JoinCapabilities = eJoinCapabilities.ToFromSIMPL,
                JoinType = eJoinType.Digital
            });
        ...
        [JoinName("VolumeMuteOff")] public JoinDataComplete VolumeMuteOff = new JoinDataComplete(
            ...
            new JoinMetadata
            {
                Description = "Volume Mute Off", JoinCapabilities = eJoinCapabilities.ToFromSIMPL,
                JoinType = eJoinType.Digital
            });
        ...
        [JoinName("InputNamesOffset")] public JoinDataComplete InputNamesOffset = new JoinDataComplete(
            new JoinData { JoinNumber = 11, JoinSpan = 10 },
            new JoinMetadata
            {
                Description = "Input Names Offset", JoinCapabilities = eJoinCapabilities.ToSIMPL,
        ...
        [JoinName("ButtonVisibilityOffset")] public JoinDataComplete ButtonVisibilityOffset = new JoinDataComplete(
            new JoinData { JoinNumber = 41, JoinSpan = 10 },
            new JoinMetadata
            {
                Description = "Button Visibility Offset", JoinCapabilities = eJoinCapabilities.ToFromSIMPL,

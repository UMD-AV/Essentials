...
namespace PepperDash.Essentials.Core
{
    ...
    public class GlsPartitionSensorController : CrestronGenericBridgeableBaseDevice, IPartitionStateProvider
    {
        ...
        public GlsPartitionSensorController(string key, Func<DeviceConfig, GlsPartCn> preActivationFunc,
            DeviceConfig config)
            : base(key, config.Name)
        {
            ...
            AddPreActivationAction(() =>
            {
                ...
                EnableFeedback = new BoolFeedback(() =>
                    InTestMode ? TestEnableFeedback : _partitionSensor.EnableFeedback.BoolValue);
                PartitionPresentFeedback = new BoolFeedback(() =>
                    InTestMode ? TestPartitionSensedFeedback : _partitionSensor.PartitionSensedFeedback.BoolValue);
                PartitionNotSensedFeedback = new BoolFeedback(() =>
                    InTestMode ? !TestPartitionSensedFeedback : _partitionSensor.PartitionNotSensedFeedback.BoolValue);
        ...
        public void SetTestEnableState(bool state)
        {
            ...
            Debug.Console(1, this, "InTestMode: {0}, unable to set enable state: {1}", InTestMode.ToString(),
                state.ToString());
        }
        ...
        public void SetTestPartitionSensedState(bool state)
        {
            ...
            Debug.Console(1, this, "InTestMode: {0}, unable to set partition state: {1}", InTestMode.ToString(),
                state.ToString());
        }
        ...
        public void SetTestSensitivityValue(int value)
        {
            ...
            Debug.Console(1, this, "InTestMode: {0}, unable to set sensitivity value: {1}", InTestMode.ToString(),
                value);
        }
        ...
        public void GetSettings()
        {
            ...
            Debug.Console(0, this, "Partition Not Sensed State: {0}",
                _partitionSensor.PartitionNotSensedFeedback.BoolValue);
        ...
        {
            Debug.Console(2, this, "Sensor is {0}, SetEnableState: {1}", _partitionSensor == null ? "null" : "not null",
                state);
            if (_partitionSensor == null)
                return;
        ...
        {
            Debug.Console(2, this, "Sensor is {0}, IncreaseSensitivity",
                _partitionSensor == null ? "null" : "not null");
            if (_partitionSensor == null)
                return;
        ...
        {
            Debug.Console(2, this, "Sensor is {0}, DecreaseSensitivity",
                _partitionSensor == null ? "null" : "not null");
            if (_partitionSensor == null)
                return;
        ...
        {
            Debug.Console(2, this, "Sensor is {0}, SetSensitivity: {1}", _partitionSensor == null ? "null" : "not null",
                value);
            if (_partitionSensor == null)
                return;

...
namespace PepperDash.Essentials.Core.Config
{
    public class TieLineConfig
    {
        ...
        public TieLine GetTieLine()
        {
            ...
            IRoutingOutputs sourceDev = DeviceManager.GetDeviceForKey(SourceKey) as IRoutingOutputs;
            if (sourceDev == null)
            {
            ...
            IRoutingInputs destDev = DeviceManager.GetDeviceForKey(DestinationKey) as IRoutingInputs;
            if (destDev == null)
            {

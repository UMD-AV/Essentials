...
namespace PepperDash.Essentials.Core
{
    ...
    public class InUseTracking
    {
        ...
        /// </summary>
        public IEnumerable<InUseTrackingObject> Users
        {
        ...
        public void AddUser(object objectToAdd, string label)
        {
            ...
            InUseTrackingObject check = _Users.FirstOrDefault(u => u.Label == label && u.User == objectToAdd);
        ...
        public void RemoveUser(object objectToRemove, string label)
        {
            ...
            InUseTrackingObject toRemove = _Users.FirstOrDefault(u => u.Label == label && u.User == objectToRemove);
            if (toRemove != null)
            {

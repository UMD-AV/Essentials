...
namespace PepperDash.Essentials.Core
{
    ...
    /// </summary>
    public abstract class CrestronGenericBaseDevice : EssentialsDevice, IOnline, IHasFeedback, ICommunicationMonitor,
        IUsageTracking
    {
        ...
        public override bool Deactivate()
        {
            ...
            bool success = Hardware.UnRegister() == eDeviceRegistrationUnRegistrationResponse.Success;
    ...
    {
        protected CrestronGenericBridgeableBaseDevice(string key, string name, GenericBase hardware) : base(key, name,
            hardware)
        {
        }
    ...
    public static class GenericBaseExtensions
    {
        public static eDeviceRegistrationUnRegistrationResponse RegisterWithLogging(this GenericBase device, string key)
        {
            ...
            Debug.ErrorLogLevel level = result == eDeviceRegistrationUnRegistrationResponse.Success

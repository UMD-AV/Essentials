...
namespace VaddioBridgePlugin
{
	public class VaddioBridgeJoinMap : JoinMapBaseAdvanced
	{
		...
		[JoinName("PipOn")]
		public JoinDataComplete PipOn = new JoinDataComplete(
			new JoinData()
			{
				JoinNumber = 11,
				JoinSpan = 1
		...
		[JoinName("PipOff")]
		public JoinDataComplete PipOff = new JoinDataComplete(
			new JoinData()
			{
				JoinNumber = 12,
				JoinSpan = 1
		...
		[JoinName("PipToggle")]
		public JoinDataComplete PipToggle = new JoinDataComplete(
			new JoinData()
			{
				JoinNumber = 13,
				JoinSpan = 1
		...
		[JoinName("PipUpperLeft")]
		public JoinDataComplete PipUpperLeft = new JoinDataComplete(
			new JoinData()
			{
				JoinNumber = 14,
				JoinSpan = 1
        ...
        [JoinName("PipUpperRight")]
        public JoinDataComplete PipUpperRight = new JoinDataComplete(
            new JoinData()
            {
                JoinNumber = 15,
                JoinSpan = 1
        ...
        [JoinName("PipLowerLeftt")]
        public JoinDataComplete PipLowerLeft = new JoinDataComplete(
            new JoinData()
            {
                JoinNumber = 16,
                JoinSpan = 1
        ...
        [JoinName("PipLowerRight")]
        public JoinDataComplete PipLowerRight = new JoinDataComplete(
            new JoinData()
            {
                JoinNumber = 17,
                JoinSpan = 1
        ...
        [JoinName("PipTopBottom")]
        public JoinDataComplete PipTopBottom = new JoinDataComplete(
            new JoinData()
            {
                JoinNumber = 18,
                JoinSpan = 1
        ...
        [JoinName("PipLeftRight")]
        public JoinDataComplete PipLeftRight = new JoinDataComplete(
            new JoinData()
            {
                JoinNumber = 19,
                JoinSpan = 1
        ...
        public JoinDataComplete VideoSource = new JoinDataComplete(
            new JoinData()
            {
                JoinNumber = 11,
                JoinSpan = 1

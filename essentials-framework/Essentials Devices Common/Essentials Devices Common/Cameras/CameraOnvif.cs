...
{
	public class CameraOnvif : CameraBase, IHasCameraPtzControl, IHasCameraPresets, IHasPowerControlWithFeedback, IBridgeAdvanced, IHasCameraFocusControl, IHasAutoFocusMode
	{
			...
			base(key, name)
		{
            ...
            onvifDevice = new OnvifDevice(props.Control.TcpSshProperties.Address, props.Control.TcpSshProperties.Username, props.Control.TcpSshProperties.Password);
    ...
    public class CameraOnvifFactory : EssentialsDeviceFactory<CameraOnvif>
    {
        ...
        public override EssentialsDevice BuildDevice(DeviceConfig dc)
        {
            ...
            var props = Newtonsoft.Json.JsonConvert.DeserializeObject<Cameras.CameraOnvifPropertiesConfig>(

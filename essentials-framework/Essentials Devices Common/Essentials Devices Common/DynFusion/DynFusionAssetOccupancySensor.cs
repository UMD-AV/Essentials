...
namespace DynFusion.Assets
{
	public class DynFusionAssetOccupancySensor : EssentialsDevice
	{
		...
		public DynFusionAssetOccupancySensor(string Name, uint JoinNumber, FusionRoom symbol, uint assetNumber) : base(Name)
		{
		...
		{
			var joinMap = new DynFusionAssetOccupancySensorJoinMap(_joinNumber + joinStart - 1);

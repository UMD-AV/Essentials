...
namespace PepperDash.Essentials.Devices.Common.SoftCodec
{
    public class BlueJeansPc : InRoomPc, IRoutingInputs, IRunRouteAction, IRoutingSink
    {
            ...
            : base(key, name)
        {
            ...
            InputPorts.Add(AnyVideoIn = new RoutingInputPort(RoutingPortNames.AnyVideoIn, eRoutingSignalType.AudioVideo,
        ...
        public void RunRouteAction(string routeKey, string sourceListKey, Action successCallback)
        {
            CrestronInvoke.BeginInvoke(o =>
            {
                ...
                Dictionary<string, SourceListItem> dict = ConfigReader.ConfigObject.GetSourceListForKey(sourceListKey);
                if (dict == null)
                {
                ...
                SourceListItem item = dict[routeKey];

                foreach (SourceRouteListItem route in item.RouteList)
                {
                    DoRoute(route);
                }
        ...
        bool DoRoute(SourceRouteListItem route)
        {
            ...
            {
                IRoutingOutputs source = DeviceManager.GetDeviceForKey(route.SourceKey) as IRoutingOutputs;
                if (source == null)
                {

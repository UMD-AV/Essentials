...
namespace PepperDash.Essentials.Devices.Common.Environment
{
    ...
    public class GenericShadesJoinMap : JoinMapBaseAdvanced
    {
        [JoinName("Shades Open")] public JoinDataComplete ShadesOpen = new JoinDataComplete(
            ...
            new JoinMetadata
            {
                Description = "Shades Open", JoinCapabilities = eJoinCapabilities.FromSIMPL,
        ...
        [JoinName("Shades Close")] public JoinDataComplete ShadesClose = new JoinDataComplete(
            ...
            new JoinMetadata
            {
                Description = "Shades Close", JoinCapabilities = eJoinCapabilities.FromSIMPL,
                JoinType = eJoinType.Digital
            });
        ...
        [JoinName("Shades Stop")] public JoinDataComplete ShadesStop = new JoinDataComplete(
            ...
            new JoinMetadata
            {
                Description = "Shades Stop", JoinCapabilities = eJoinCapabilities.FromSIMPL,
                JoinType = eJoinType.Digital
            });
        ...
        [JoinName("Shades Open Name")] public JoinDataComplete ShadesOpenName = new JoinDataComplete(
            ...
            new JoinMetadata
            {
                Description = "Shades Open Name", JoinCapabilities = eJoinCapabilities.FromSIMPL,
        ...
        [JoinName("Shades Close Name")] public JoinDataComplete ShadesCloseName = new JoinDataComplete(
            ...
            new JoinMetadata
            {
                Description = "Shades Close Name", JoinCapabilities = eJoinCapabilities.FromSIMPL,
                JoinType = eJoinType.Serial
            });
        ...
        [JoinName("Shades Stop Name")] public JoinDataComplete ShadesStopName = new JoinDataComplete(
            ...
            new JoinMetadata
            {
                Description = "Shades Stop Name", JoinCapabilities = eJoinCapabilities.FromSIMPL,
                JoinType = eJoinType.Serial
            });

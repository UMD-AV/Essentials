...
namespace DynFusion
{
    public class DynFusionConfigObjectTemplate
    {
        ...
        [JsonProperty("customAttributes")] public CustomAttributes CustomAttributes { get; set; }

        [JsonProperty("customProperties")] public CustomProperties CustomProperties { get; set; }

        [JsonProperty("Assets")] public AssetsClass Assets { get; set; }

        [JsonProperty("DeviceUsage")] public DeviceUsage DeviceUsage { get; set; }
    }
    ...
    public class FusionEssentialsAsset
    {
        ...
        [JsonProperty("FeedbackName")] public string Feedback { get; set; }

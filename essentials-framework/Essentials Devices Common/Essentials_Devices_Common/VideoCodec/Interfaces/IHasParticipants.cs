...
namespace PepperDash.Essentials.Devices.Common.VideoCodec.Interfaces
{
    ...
    public class CodecParticipants
    {
        ...
        {
            get { return _currentParticipants.FirstOrDefault(p => p.IsHost); }
        }
        ...
        {
            EventHandler<EventArgs> handler = ParticipantsListHasChanged;
        ...
        {
            EventHandler<ParticipantEventArgs> handler = ParticipantUpdated;
        ...
        {
            EventHandler<EventArgs> handler = ParticipantAdded;
        ...
        {
            EventHandler<EventArgs> handler = ParticipantRemoved;

...
namespace PepperDash.Essentials.Devices.Common.Codec
{
    public class CiscoSparkCodecPropertiesConfig
    {
        ...
        [JsonProperty("zoomSuffix")] public string ZoomSuffix { get; set; }

        [JsonProperty("showSelfViewByDefault")]
        public bool ShowSelfViewByDefault { get; set; }

        [JsonProperty("sharing")] public SharingProperties Sharing { get; set; }
        ...
        [JsonProperty("cameraNames")] public Dictionary<string, string> CameraNames { get; set; }
        ...
        [JsonProperty("UiBranding")] public BrandingLogoProperties UiBranding { get; set; }

        [JsonProperty("cameraInfo")] public List<CameraInfo> CameraInfo { get; set; }
    ...
    public class BrandingLogoProperties
    {
        ...
        [JsonProperty("brandingUrl")] public string BrandingUrl { get; set; }
    }

...
namespace PepperDash.Essentials.Devices.Common.VideoCodec.Cisco
{
    ...
    public class CiscoCodecStatus
    {
        ...
        public class Audio
        {
            ...
            public Microphones
                Microphones { get; set; } // Can we have this setter fire the update on the CiscoCodec feedback?
        ...
        public class Duration : ValueProperty
        {
            ...
            {
                get { return new TimeSpan(0, 0, int.Parse(_Value)); }
            }
        }

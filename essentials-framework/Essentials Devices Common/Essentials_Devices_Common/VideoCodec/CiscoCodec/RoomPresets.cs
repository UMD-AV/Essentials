...
namespace PepperDash.Essentials.Devices.Common.VideoCodec
{
    ...
    public static class RoomPresets
    {
        ...
        /// <returns></returns>
        public static List<TDestination> GetGenericPresets<TSource, TDestination>(this List<TSource> presets)
            where TSource : ConvertiblePreset where TDestination : PresetBase
        {
            return

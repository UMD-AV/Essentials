...
namespace PepperDash.Essentials.Devices.Common.VideoCodec.Cisco
{
    public class CiscoFarEndCamera : CameraBase, IHasCameraPtzControl, IAmFarEndCamera, IBridgeAdvanced
    {
        ...
        {
            get { return (ParentCodec as CiscoSparkCodec).GetCallId(); }
        }
        ...
        public void PanLeft()
        {
            ParentCodec.EnqueueCommand(string.Format("xCommand Call FarEndControl Camera Move Value: Left CallId: {0}",
                CallId));
        }

        public void PanRight()
        {
            ParentCodec.EnqueueCommand(string.Format("xCommand Call FarEndControl Camera Move Value: Right CallId: {0}",
                CallId));
        }
        ...
        {
            ParentCodec.EnqueueCommand(string.Format("xCommand Call FarEndControl Camera Move Value: Down CallId: {0}",
                CallId));
        }

        public void TiltUp()
        {
            ParentCodec.EnqueueCommand(string.Format("xCommand Call FarEndControl Camera Move Value: Up CallId: {0}",
                CallId));
        }
        ...
        public void ZoomIn()
        {
            ParentCodec.EnqueueCommand(
                string.Format("xCommand Call FarEndControl Camera Move Value: ZoomIn CallId: {0}", CallId));
        }

        public void ZoomOut()
        {
            ParentCodec.EnqueueCommand(
                string.Format("xCommand Call FarEndControl Camera Move Value: ZoomOut CallId: {0}", CallId));
        }
    ...
    public class CiscoSparkCamera : CameraBase, IHasCameraPtzControl, IHasCameraFocusControl, IBridgeAdvanced
    {
        ...
        {
            get { return isPanning || isTilting || isZooming || isFocusing; }
        }
        ...
        public void PanLeft()
        {
            if (!isMoving)
            {
                ParentCodec.EnqueueCommand(string.Format("xCommand Camera Ramp CameraId: {0} Pan: Left PanSpeed: {1}",
                    CameraId, PanSpeed));
                isPanning = true;
            }
        }
        ...
        public void PanRight()
        {
            if (!isMoving)
            {
                ParentCodec.EnqueueCommand(string.Format("xCommand Camera Ramp CameraId: {0} Pan: Right PanSpeed: {1}",
                    CameraId, PanSpeed));
                isPanning = true;
            }
        }
        ...
        public void TiltDown()
        {
            if (!isMoving)
            {
                ParentCodec.EnqueueCommand(string.Format("xCommand Camera Ramp CameraId: {0} Tilt: Down TiltSpeed: {1}",
                    CameraId, TiltSpeed));
                isTilting = true;
            }
        }
        ...
        public void TiltUp()
        {
            if (!isMoving)
            {
                ParentCodec.EnqueueCommand(string.Format("xCommand Camera Ramp CameraId: {0} Tilt: Up TiltSpeed: {1}",
                    CameraId, TiltSpeed));
                isTilting = true;
            }
        }
        ...
        public void ZoomIn()
        {
            if (!isMoving)
            {
                ParentCodec.EnqueueCommand(string.Format("xCommand Camera Ramp CameraId: {0} Zoom: In ZoomSpeed: {1}",
                    CameraId, ZoomSpeed));
                isZooming = true;
            }
        }
        ...
        public void ZoomOut()
        {
            if (!isMoving)
            {
                ParentCodec.EnqueueCommand(string.Format("xCommand Camera Ramp CameraId: {0} Zoom: Out ZoomSpeed: {1}",
                    CameraId, ZoomSpeed));
                isZooming = true;
            }
        }

...
namespace PepperDash.Essentials.Devices.Common.VideoCodec.ZoomRoom
{
    ...
    public class Response
    {
        ...
        [JsonProperty("topKey")] public string TopKey { get; set; }
    ...
    public class zStatus
    {
        public class Login
        {
            [JsonProperty("ZAAPI Release")] public string ZAAPIRelease { get; set; }
            [JsonProperty("Zoom Room Release")] public string ZoomRoomRelease { get; set; }
        }
        ...
        public class SystemUnit
        {
            ...
            [JsonProperty("meeting_number")] public string MeetingNumber { get; set; }
            [JsonProperty("platform")] public string Platform { get; set; }
            [JsonProperty("room_info")] public RoomInfo RoomInfo { get; set; }
            [JsonProperty("room_version")] public string RoomVersion { get; set; }
        ...
        {
            [JsonProperty("account_email")] public string AccountEmail { get; set; }
        ...
        public class Contact
        {
            ...
            [JsonProperty("cloud_pbx_info")] public CloudPbxInfo CloudPbxInfo { get; set; }
            [JsonProperty("email")] public string Email { get; set; }
            [JsonProperty("firstName")] public string FirstName { get; set; }
            [JsonProperty("index")] public int Index { get; set; }
            [JsonProperty("isLegacy")] public bool IsLegacy { get; set; }
            [JsonProperty("isZoomRoom")] public bool IsZoomRoom { get; set; }
            [JsonProperty("jid")] public string Jid { get; set; }
            [JsonProperty("lastName")] public string LastName { get; set; }
            [JsonProperty("onDesktop")] public bool OnDesktop { get; set; }
            [JsonProperty("onMobile")] public bool OnMobile { get; set; }
            [JsonProperty("phoneNumber")] public string PhoneNumber { get; set; }
            [JsonProperty("presence")] public ePresence Presence { get; set; }
            [JsonProperty("presence_status")] public int PresenceStatus { get; set; }
            [JsonProperty("screenName")] public string ScreenName { get; set; }
            [JsonProperty("sip_phone_number")] public string SipPhoneNumber { get; set; }
        ...
        public class Phonebook
        {
            ...
            public static CodecDirectory ConvertZoomContactsToGeneric(List<Contact> zoomContacts)
            {
                ...
                DirectoryFolder roomFolder = new DirectoryFolder();

                DirectoryFolder contactFolder = new DirectoryFolder();

                List<DirectoryItem> contacts = new List<DirectoryItem>();

                // Check if there are any zoom rooms
                List<Contact> zoomRooms = zoomContacts.FindAll(c => c.IsZoomRoom);
        ...
        public class NumberOfScreens : NotifiableObject
        {
            ...
            [JsonProperty("NumberOfCECScreens")] public int NumOfCECScreens { get; set; }

            [JsonProperty("NumberOfScreens")]
            public int NumOfScreens
            {
                get { return _numOfScreens; }
                set
                {
        ...
        public class Layout : NotifiableObject
        {
            ...
            {
                get { return _can_Switch_Floating_Share_Content; }
                set
                {
            ...
            {
                get { return _can_Switch_Share_On_All_Screens; }
                set
                {
            ...
            {
                get { return _can_Switch_Speaker_View; }
                set
                {
            ...
            {
                get { return _can_Switch_Wall_View; }
                set
                {
            ...
            {
                get { return _can_Switch_Strip_View; }
                set
                {
        ...
        public class CallRecordInfo : NotifiableObject
        {
            ...
            {
                get { return _meetingIsBeingRecorded; }
                set
                {
            ...
            {
                get { return canRecord && !emailRequired; }
            }
    ...
    public class zEvent
    {
        ...
        {
            [JsonProperty("can_be_pinned")] public bool CanBePinned { get; set; }
            [JsonProperty("can_pin_share")] public bool CanPinShare { get; set; }

            [JsonProperty("pinned_share_source_id")]
            public int PinnedShareSourceId { get; set; }

            [JsonProperty("pinned_user_id")] public int PinnedUserId { get; set; }
            [JsonProperty("screen_index")] public int ScreenIndex { get; set; }
            [JsonProperty("screen_layout")] public int ScreenLayout { get; set; }
            [JsonProperty("share_source_type")] public int ShareSourceType { get; set; }
            [JsonProperty("why_cannot_pin_share")] public string WhyCannotPinShare { get; set; }
        }
        ...
        {
            [JsonProperty("needsPassword")] public bool NeedsPassword { get; set; }

            [JsonProperty("wrongAndRetry")] public bool WrongAndRetry { get; set; }
        }
    }
    ...
    public class zConfiguration
    {
        ...
        {
            [JsonProperty("reduce_reverb")] public bool ReduceReverb { get; set; }
        }
        ...
        public class Output : NotifiableObject
        {
            ...
            [JsonProperty("selectedId")] public string SelectedId { get; set; }
            [JsonProperty("is_sap_disabled")] public bool IsSapDisabled { get; set; }
        }
    ...
    public class zCommand
    {
        ...
        {
            [JsonProperty("accessRole")] public string AccessRole { get; set; }
            [JsonProperty("calendarChangeKey")] public string CalendarChangeKey { get; set; }
            [JsonProperty("calendarID")] public string CalendarId { get; set; }
            [JsonProperty("checkIn")] public bool CheckIn { get; set; }
            [JsonProperty("creatorEmail")] public string CreatorEmail { get; set; }
            [JsonProperty("creatorName")] public string CreatorName { get; set; }
            [JsonProperty("endTime")] public DateTime EndTime { get; set; }
            [JsonProperty("hostName")] public string HostName { get; set; }
            [JsonProperty("isInstantMeeting")] public bool IsInstantMeeting { get; set; }
            [JsonProperty("isPrivate")] public bool IsPrivate { get; set; }
            [JsonProperty("location")] public string Location { get; set; }
            [JsonProperty("meetingName")] public string MeetingName { get; set; }
            [JsonProperty("meetingNumber")] public string MeetingNumber { get; set; }
            [JsonProperty("scheduledFrom")] public string ScheduledFrom { get; set; }
            [JsonProperty("startTime")] public DateTime StartTime { get; set; }
            [JsonProperty("third_party")] public ThirdParty ThirdParty { get; set; }
        }
        ...
        public static List<Meeting> GetGenericMeetingsFromBookingResult(List<BookingsListResult> bookings)
        {
            ...
            foreach (BookingsListResult b in bookings)
            {
                ...
                if (Debug.Level > 0)
                {
                    Debug.Console(1, "Title: {0}, ID: {1}, Organizer: {2}", meeting.Title, meeting.Id,
                        meeting.Organizer);
                    Debug.Console(1, "    Start Time: {0}, End Time: {1}, Duration: {2}", meeting.StartTime,
        ...
        {
            [JsonProperty("is_raise_hand")] public bool IsRaiseHand { get; set; }
            [JsonProperty("is_valid")] public string IsValid { get; set; }
            [JsonProperty("time_stamp")] public string TimeStamp { get; set; }
        ...
        {
            [JsonProperty("audio_status state")] public string AudioStatusState { get; set; }
            [JsonProperty("audio_status type")] public string AudioStatusType { get; set; }
            ...
            [JsonProperty("can_record")] public bool CanRecord { get; set; }
            [JsonProperty("event")] public string Event { get; set; }
            [JsonProperty("hand_status")] public HandStatus HandStatus { get; set; }
            ...
            [JsonProperty("is_host")] public bool IsHost { get; set; }
            [JsonProperty("is_in_waiting_room")] public bool IsInWaitingRoom { get; set; }
            [JsonProperty("is_myself")] public bool IsMyself { get; set; }
            ...
            public static List<ListParticipant> SortParticipantListByHandStatus(List<ListParticipant> participants)
            {
                ...
                {
                    IOrderedEnumerable<ListParticipant> orderByDescending =
                        handRaisedParticipantsList.OrderByDescending(p => p.HandStatus.TimeStamp);
                }

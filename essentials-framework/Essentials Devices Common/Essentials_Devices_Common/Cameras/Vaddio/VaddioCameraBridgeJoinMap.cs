...
{
    public class VaddioCameraBridgeJoinMap : JoinMapBaseAdvanced
    {
        #region Digital
        ...
        public VaddioCameraBridgeJoinMap(uint joinStart)
            : base(joinStart, typeof(VaddioCameraBridgeJoinMap))
        {
        }
    }
}
...
{
    public abstract class NvxBaseDeviceFactory<T> : EssentialsDeviceFactory<T> where T : EssentialsDevice
    {
        ...
        {
            NvxXioDirector result = DeviceManager.GetDeviceForKey(key) as NvxXioDirector;
            if (result == null)
                ...
                case "dmnvx350":
                {
                    ...
                    return () =>
                    {
                        ...
                        return xio.Hardware.Domain.TryGetValue(props.DomainId, out domain)
                            ...
                            : new DmNvx350((uint)props.DeviceId, xio.Hardware.Domain.Values.FirstOrDefault(),
                ...
                case "dmnvx350c":
                {
                    ...
                    return () =>
                    {
                        ...
                        return xio.Hardware.Domain.TryGetValue(props.DomainId, out domain)
                            ...
                            : new DmNvx350C((uint)props.DeviceId, xio.Hardware.Domain.Values.FirstOrDefault(),
                                !props.DeviceIsTransmitter());
                    };
                }
                case "dmnvx351":
                {
                    ...
                    return () =>
                    {
                        ...
                        return xio.Hardware.Domain.TryGetValue(props.DomainId, out domain)
                            ...
                            : new DmNvx351((uint)props.DeviceId, xio.Hardware.Domain.Values.FirstOrDefault(),
                                !props.DeviceIsTransmitter());
                    };
                }
                case "dmnvx351c":
                {
                    ...
                    return () =>
                    {
                        ...
                        return xio.Hardware.Domain.TryGetValue(props.DomainId, out domain)
                            ...
                            : new DmNvx351C((uint)props.DeviceId, xio.Hardware.Domain.Values.FirstOrDefault(),
                                !props.DeviceIsTransmitter());
                    };
                }
                case "dmnvx352":
                {
                    ...
                    return () =>
                    {
                        ...
                        return xio.Hardware.Domain.TryGetValue(props.DomainId, out domain)
                            ...
                            : new DmNvx352((uint)props.DeviceId, xio.Hardware.Domain.Values.FirstOrDefault(),
                                !props.DeviceIsTransmitter());
                    };
                }
                case "dmnvx352c":
                {
                    ...
                    return () =>
                    {
                        ...
                        return xio.Hardware.Domain.TryGetValue(props.DomainId, out domain)
                            ...
                            : new DmNvx352C((uint)props.DeviceId, xio.Hardware.Domain.Values.FirstOrDefault(),
                                !props.DeviceIsTransmitter());
                    };
                }
                case "dmnvx360":
                {
                    ...
                    return () =>
                    {
                        ...
                        return xio.Hardware.Domain.TryGetValue(props.DomainId, out domain)
                            ...
                            : new DmNvx360((uint)props.DeviceId, xio.Hardware.Domain.Values.FirstOrDefault(),
                                !props.DeviceIsTransmitter());
                    };
                }
                case "dmnvx360c":
                {
                    ...
                    return () =>
                    {
                        ...
                        return xio.Hardware.Domain.TryGetValue(props.DomainId, out domain)
                            ...
                            : new DmNvx360C((uint)props.DeviceId, xio.Hardware.Domain.Values.FirstOrDefault(),
                                !props.DeviceIsTransmitter());
                    };
                }
                case "dmnvx363":
                {
                    ...
                    return () =>
                    {
                        ...
                        return xio.Hardware.Domain.TryGetValue(props.DomainId, out domain)
                            ...
                            : new DmNvx363((uint)props.DeviceId, xio.Hardware.Domain.Values.FirstOrDefault(),
                                !props.DeviceIsTransmitter());
                    };
                }
                case "dmnvx363c":
                {
                    ...
                    return () =>
                    {
                        ...
                        return xio.Hardware.Domain.TryGetValue(props.DomainId, out domain)
                            ...
                            : new DmNvx363C((uint)props.DeviceId, xio.Hardware.Domain.Values.FirstOrDefault(),
                                !props.DeviceIsTransmitter());
                    };
                }
                case "dmnvxd30":

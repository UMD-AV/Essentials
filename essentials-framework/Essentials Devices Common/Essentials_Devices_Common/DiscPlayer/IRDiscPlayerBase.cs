...
{
    public class IRBlurayBase : EssentialsBridgeableDevice, IDiscPlayerControls, IUiDisplayInfo, IRoutingOutputs,
        IUsageTracking
    {
        ...
        {
            get { return DisplayUiConstants.TypeBluray; }
        }
        ...
        {
            IRBlurayBaseJoinMap joinMap = new IRBlurayBaseJoinMap(joinStart);
            ...
            IHasPowerControl powerDev = this as IHasPowerControl;
            if (powerDev != null)
            {
            ...
            IChannel channelDev = this as IChannel;
            if (channelDev != null)
            {
            ...
            IColor colorDev = this as IColor;
            if (colorDev != null)
            {
            ...
            if (keypadDev != null)
            {
                ...
                trilist.SetBoolSigAction(joinMap.KeypadAccessoryButton1Press.JoinNumber,
                    keypadDev.KeypadAccessoryButton1);
            ...
            ITransport transportDev = this as ITransport;

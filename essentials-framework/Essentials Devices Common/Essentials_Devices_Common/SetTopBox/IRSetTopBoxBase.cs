...
namespace PepperDash.Essentials.Devices.Common
{
    ...
    public class IRSetTopBoxBase : EssentialsBridgeableDevice, ISetTopBoxControls, IRoutingOutputs, IUsageTracking,
        IHasPowerControl, ITvPresetsProvider
    {
        public IrOutputPortController IrPort { get; private set; }

        public uint DisplayUiType
        {
            get { return DisplayUiConstants.TypeDirecTv; }
        }
            ...
            : base(key, name)
        {
            ...
            AnyVideoOut = new RoutingOutputPort(RoutingPortNames.AnyVideoOut,
        ...
        {
            SetTopBoxControllerJoinMap joinMap = new SetTopBoxControllerJoinMap(joinStart);
            ...
            ISetTopBoxControls stbBase = this as ISetTopBoxControls;
            if (stbBase != null)
            {
            ...
            IHasPowerControl stbPower = this as IHasPowerControl;
            if (stbPower != null)
            {
            ...
            IChannel stbChannel = this as IChannel;
            if (stbChannel != null)
            {
            ...
            IColor stbColor = this as IColor;
            if (stbColor != null)
            {
            ...
            ISetTopBoxNumericKeypad stbKeypad = this as ISetTopBoxNumericKeypad;
            if (stbKeypad != null)
            {
                trilist.StringInput[joinMap.KeypadAccessoryButton1Label.JoinNumber].StringValue =
                    stbKeypad.KeypadAccessoryButton1Label;
                trilist.StringInput[joinMap.KeypadAccessoryButton2Label.JoinNumber].StringValue =
                    stbKeypad.KeypadAccessoryButton2Label;

                trilist.BooleanInput[joinMap.HasKeypadAccessoryButton1.JoinNumber].BoolValue =
                    stbKeypad.HasKeypadAccessoryButton1;
                trilist.BooleanInput[joinMap.HasKeypadAccessoryButton2.JoinNumber].BoolValue =
                    stbKeypad.HasKeypadAccessoryButton2;
                ...
                trilist.SetBoolSigAction(joinMap.KeypadAccessoryButton1Press.JoinNumber,
                    stbKeypad.KeypadAccessoryButton1);
                trilist.SetBoolSigAction(joinMap.KeypadAccessoryButton2Press.JoinNumber,
                    stbKeypad.KeypadAccessoryButton1);
            ...
            ITransport stbTransport = this as ITransport;
    ...
    public class IRSetTopBoxBaseFactory : EssentialsDeviceFactory<IRSetTopBoxBase>
    {
        ...
        public override EssentialsDevice BuildDevice(DeviceConfig dc)
        {
            ...
            IrOutputPortController irCont = IRPortHelper.GetIrOutputPortController(dc);
            SetTopBoxPropertiesConfig config = dc.Properties.ToObject<SetTopBoxPropertiesConfig>();
            IRSetTopBoxBase stb = new IRSetTopBoxBase(dc.Key, dc.Name, irCont, config);

            string listName = dc.Properties.Value<string>("presetsList");
            if (listName != null)

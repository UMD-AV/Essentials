...
namespace QscQsysDspPlugin
{
    ...
    public static class QscDspDeviceApiExtensions
    {
            ...
            EiscApiAdvanced bridge)
        {
            ...
            // VoIP Dialer
            uint lineOffset = 0;
            foreach (KeyValuePair<string, QscDspDialer> line in DspDevice.Dialers)
            {
                KeyValuePair<string, QscDspDialer> dialer = line;

                uint dialerLineOffset = lineOffset;
                Debug.Console(2, "AddingDialerBRidge {0} {1} Offset", dialer.Key, dialerLineOffset);

                // from SiMPL > to Plugin
                trilist.SetSigTrueAction((joinMap.Keypad0.JoinNumber + dialerLineOffset),
                    () => DspDevice.Dialers[dialer.Key].SendKeypad(QscDspDialer.EKeypadKeys.Num0));
                trilist.SetSigTrueAction((joinMap.Keypad1.JoinNumber + dialerLineOffset),
                    () => dialer.Value.SendKeypad(QscDspDialer.EKeypadKeys.Num1));
                trilist.SetSigTrueAction((joinMap.Keypad2.JoinNumber + dialerLineOffset),
                    () => dialer.Value.SendKeypad(QscDspDialer.EKeypadKeys.Num2));
                trilist.SetSigTrueAction((joinMap.Keypad3.JoinNumber + dialerLineOffset),
                    () => dialer.Value.SendKeypad(QscDspDialer.EKeypadKeys.Num3));
                trilist.SetSigTrueAction((joinMap.Keypad4.JoinNumber + dialerLineOffset),
                    () => dialer.Value.SendKeypad(QscDspDialer.EKeypadKeys.Num4));
                trilist.SetSigTrueAction((joinMap.Keypad5.JoinNumber + dialerLineOffset),
                    () => dialer.Value.SendKeypad(QscDspDialer.EKeypadKeys.Num5));
                trilist.SetSigTrueAction((joinMap.Keypad6.JoinNumber + dialerLineOffset),
                    () => dialer.Value.SendKeypad(QscDspDialer.EKeypadKeys.Num6));
                trilist.SetSigTrueAction((joinMap.Keypad7.JoinNumber + dialerLineOffset),
                    () => dialer.Value.SendKeypad(QscDspDialer.EKeypadKeys.Num7));
                trilist.SetSigTrueAction((joinMap.Keypad8.JoinNumber + dialerLineOffset),
                    () => dialer.Value.SendKeypad(QscDspDialer.EKeypadKeys.Num8));
                trilist.SetSigTrueAction((joinMap.Keypad9.JoinNumber + dialerLineOffset),
                    () => dialer.Value.SendKeypad(QscDspDialer.EKeypadKeys.Num9));
                trilist.SetSigTrueAction((joinMap.KeypadStar.JoinNumber + dialerLineOffset),
                    () => dialer.Value.SendKeypad(QscDspDialer.EKeypadKeys.Star));
                trilist.SetSigTrueAction((joinMap.KeypadPound.JoinNumber + dialerLineOffset),
                    () => dialer.Value.SendKeypad(QscDspDialer.EKeypadKeys.Pound));
                trilist.SetSigTrueAction((joinMap.KeypadClear.JoinNumber + dialerLineOffset),
                    () => dialer.Value.SendKeypad(QscDspDialer.EKeypadKeys.Clear));
                trilist.SetSigTrueAction((joinMap.KeypadBackspace.JoinNumber + dialerLineOffset),
                    () => dialer.Value.SendKeypad(QscDspDialer.EKeypadKeys.Backspace));
                // from SiMPL > to Plugin
                trilist.SetSigTrueAction(joinMap.Dial.JoinNumber + dialerLineOffset, () => dialer.Value.Dial());
                trilist.SetSigTrueAction(joinMap.DoNotDisturbToggle.JoinNumber + dialerLineOffset,
                    () => dialer.Value.DoNotDisturbToggle());
                trilist.SetSigTrueAction(joinMap.DoNotDisturbOn.JoinNumber + dialerLineOffset,
                    () => dialer.Value.DoNotDisturbOn());
                trilist.SetSigTrueAction(joinMap.DoNotDisturbOff.JoinNumber + dialerLineOffset,
                    () => dialer.Value.DoNotDisturbOff());
                trilist.SetSigTrueAction(joinMap.AutoAnswerToggle.JoinNumber + dialerLineOffset,
                    () => dialer.Value.AutoAnswerToggle());
                trilist.SetSigTrueAction(joinMap.AutoAnswerOn.JoinNumber + dialerLineOffset,
                    () => dialer.Value.AutoAnswerOn());
                trilist.SetSigTrueAction(joinMap.AutoAnswerOff.JoinNumber + dialerLineOffset,
                    () => dialer.Value.AutoAnswerOff());
                trilist.SetSigTrueAction(joinMap.EndCall.JoinNumber + dialerLineOffset,
                    () => dialer.Value.EndAllCalls());
                trilist.SetSigTrueAction(joinMap.IncomingCallAccept.JoinNumber + dialerLineOffset,
                    () => dialer.Value.AcceptCall());
                trilist.SetSigTrueAction(joinMap.IncomingCallReject.JoinNumber + dialerLineOffset,
                    () => dialer.Value.RejectCall());

                // from Plugin > to SiMPL
                dialer.Value.DoNotDisturbFeedback.LinkInputSig(
                    trilist.BooleanInput[joinMap.DoNotDisturbToggle.JoinNumber + dialerLineOffset]);
                dialer.Value.DoNotDisturbFeedback.LinkInputSig(
                    trilist.BooleanInput[joinMap.DoNotDisturbOn.JoinNumber + dialerLineOffset]);
                dialer.Value.DoNotDisturbFeedback.LinkComplementInputSig(
                    trilist.BooleanInput[joinMap.DoNotDisturbOff.JoinNumber + dialerLineOffset]);

                // from Plugin > to SiMPL
                dialer.Value.AutoAnswerFeedback.LinkInputSig(
                    trilist.BooleanInput[joinMap.AutoAnswerToggle.JoinNumber + dialerLineOffset]);
                dialer.Value.AutoAnswerFeedback.LinkInputSig(
                    trilist.BooleanInput[joinMap.AutoAnswerOn.JoinNumber + dialerLineOffset]);
                dialer.Value.AutoAnswerFeedback.LinkComplementInputSig(
                    trilist.BooleanInput[joinMap.AutoAnswerOff.JoinNumber + dialerLineOffset]);
                dialer.Value.CallerIdNumberFb.LinkInputSig(
                    trilist.StringInput[joinMap.CallerIdNumberFb.JoinNumber + dialerLineOffset]);

                // from Plugin > to SiMPL
                dialer.Value.OffHookFeedback.LinkInputSig(
                    trilist.BooleanInput[joinMap.Dial.JoinNumber + dialerLineOffset]);
                dialer.Value.OffHookFeedback.LinkInputSig(
                    trilist.BooleanInput[joinMap.OffHook.JoinNumber + dialerLineOffset]);
                dialer.Value.OffHookFeedback.LinkComplementInputSig(
                    trilist.BooleanInput[joinMap.OnHook.JoinNumber + dialerLineOffset]);
                dialer.Value.DialStringFeedback.LinkInputSig(
                    trilist.StringInput[joinMap.DialStringCmd.JoinNumber + dialerLineOffset]);

                // from Plugin > to SiMPL
                dialer.Value.IncomingCallFeedback.LinkInputSig(
                    trilist.BooleanInput[joinMap.IncomingCall.JoinNumber + dialerLineOffset]);
    ...
    public class QscDspDeviceJoinMap : JoinMapBaseAdvanced
    {
        ...
        [JoinName("DialStringCmd")] public JoinDataComplete DialStringCmd =
            new JoinDataComplete(new JoinData { JoinNumber = 3100, JoinSpan = 1 },
                new JoinMetadata
                {
        ...
        [JoinName("Keypad0")] public JoinDataComplete Keypad0 =
        ...
        [JoinName("Keypad1")] public JoinDataComplete Keypad1 =
        ...
        [JoinName("Keypad2")] public JoinDataComplete Keypad2 =
        ...
        [JoinName("Keypad3")] public JoinDataComplete Keypad3 =
        ...
        [JoinName("Keypad4")] public JoinDataComplete Keypad4 =
        ...
        [JoinName("Keypad5")] public JoinDataComplete Keypad5 =
        ...
        [JoinName("Keypad6")] public JoinDataComplete Keypad6 =
        ...
        [JoinName("Keypad7")] public JoinDataComplete Keypad7 =
        ...
        [JoinName("Keypad8")] public JoinDataComplete Keypad8 =
        ...
        [JoinName("Keypad9")] public JoinDataComplete Keypad9 =
        ...
        [JoinName("Dial")] public JoinDataComplete Dial =
        ...
        [JoinName("IncomingCallAccept")] public JoinDataComplete IncomingCallAccept =

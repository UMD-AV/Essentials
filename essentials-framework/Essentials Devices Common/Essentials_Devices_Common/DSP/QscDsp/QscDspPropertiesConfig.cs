...
namespace QscQsysDspPlugin
{
    ...
    public class QscDialerConfig
    {
        ...
        [JsonProperty("dialStringTag")] public string DialStringTag { get; set; }

        [JsonProperty("disconnectTag")] public string DisconnectTag { get; set; }

        [JsonProperty("connectTag")] public string ConnectTag { get; set; }

        [JsonProperty("callStatusTag")] public string CallStatusTag { get; set; }

        [JsonProperty("hookStatusTag")] public string HookStatusTag { get; set; }

        [JsonProperty("doNotDisturbTag")] public string DoNotDisturbTag { get; set; }

        [JsonProperty("autoAnswerTag")] public string AutoAnswerTag { get; set; }

        [JsonProperty("keypadBackspaceTag")] public string KeypadBackspaceTag { get; set; }

        [JsonProperty("keypadClearTag")] public string KeypadClearTag { get; set; }

        [JsonProperty("keypad1Tag")] public string Keypad1Tag { get; set; }

        [JsonProperty("keypad2Tag")] public string Keypad2Tag { get; set; }

        [JsonProperty("keypad3Tag")] public string Keypad3Tag { get; set; }

        [JsonProperty("keypad4Tag")] public string Keypad4Tag { get; set; }

        [JsonProperty("keypad5Tag")] public string Keypad5Tag { get; set; }

        [JsonProperty("keypad6Tag")] public string Keypad6Tag { get; set; }

        [JsonProperty("keypad7Tag")] public string Keypad7Tag { get; set; }

        [JsonProperty("keypad8Tag")] public string Keypad8Tag { get; set; }

        [JsonProperty("keypad9Tag")] public string Keypad9Tag { get; set; }

        [JsonProperty("keypad0Tag")] public string Keypad0Tag { get; set; }

        [JsonProperty("keypadPoundTag")] public string KeypadPoundTag { get; set; }

        [JsonProperty("keypadStarTag")] public string KeypadStarTag { get; set; }
    }
    ...
    {
        [JsonProperty("panLeftTag")] public string PanLeftTag { get; set; }

        [JsonProperty("panRightTag")] public string PanRightTag { get; set; }

        [JsonProperty("tiltUpTag")] public string TiltUpTag { get; set; }

        [JsonProperty("tiltDownTag")] public string TiltDownTag { get; set; }

        [JsonProperty("zoomInTag")] public string ZoomInTag { get; set; }

        [JsonProperty("zoomOutTag")] public string ZoomOutTag { get; set; }

        [JsonProperty("presetBankTag")] public string PresetBankTag { get; set; }

        [JsonProperty("privacy")] public string Privacy { get; set; }

        [JsonProperty("onlineStatus")] public string OnlineStatus { get; set; }

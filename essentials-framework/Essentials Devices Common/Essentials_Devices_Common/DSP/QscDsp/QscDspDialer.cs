        ...
        public void Subscribe()
        {
            try
            {
                ...
                foreach (PropertyInfo prop in properties)
                {
                    ...
                    {
                        string propValue = prop.GetValue(Tags, null) as string;
        ...
        public void SendKeypad(EKeypadKeys button)
        {
            ...
            switch (button)
            {
                case EKeypadKeys.Num0:
                    keypadTag = Tags.Keypad0Tag;
                    break;
                case EKeypadKeys.Num1:
                    keypadTag = Tags.Keypad1Tag;
                    break;
                case EKeypadKeys.Num2:
                    keypadTag = Tags.Keypad2Tag;
                    break;
                case EKeypadKeys.Num3:
                    keypadTag = Tags.Keypad3Tag;
                    break;
                case EKeypadKeys.Num4:
                    keypadTag = Tags.Keypad4Tag;
                    break;
                case EKeypadKeys.Num5:
                    keypadTag = Tags.Keypad5Tag;
                    break;
                case EKeypadKeys.Num6:
                    keypadTag = Tags.Keypad6Tag;
                    break;
                case EKeypadKeys.Num7:
                    keypadTag = Tags.Keypad7Tag;
                    break;
                case EKeypadKeys.Num8:
                    keypadTag = Tags.Keypad8Tag;
                    break;
                case EKeypadKeys.Num9:
                    keypadTag = Tags.Keypad9Tag;
                    break;
                case EKeypadKeys.Pound:
                    keypadTag = Tags.KeypadPoundTag;
                    break;
                case EKeypadKeys.Star:
                    keypadTag = Tags.KeypadStarTag;
                    break;
                case EKeypadKeys.Backspace:
                    keypadTag = Tags.KeypadBackspaceTag;
                    break;
                case EKeypadKeys.Clear:
                    keypadTag = Tags.KeypadClearTag;
                    break;
            }

            if (keypadTag != null)
            {
                string cmdToSend = string.Format("ct \"{0}\"", keypadTag);

...
namespace Tesira_DSP_EPI
{
    public class TesiraDspDialerControlPoint : AudioCodecBase, ISubscribedComponent
    {
        ...
        protected TesiraDspDialerControlPoint(string key, string instanceTag1, string instanceTag2, int index1,
            int index2, TesiraDsp parent, uint? bridgeIndex)
        ...
        public virtual void SendFullCommand(string command, string attributeCode, string value, int instanceTag)
        {
            ...
            else
            {
                ...
                cmd = string.IsNullOrEmpty(value)
                    ? string.Format("{0} {1} {2}", localInstanceTag, command, attributeCode)
                    : string.Format("{0} {1} {2} {3}", localInstanceTag, command, attributeCode, value);
            }

...
namespace Tesira_DSP_EPI
{
    public class TesiraDspFaderControl : TesiraDspControlPoint, IBasicVolumeWithFeedback, IVolumeComponent
    {
        ...
        private string LevelControlPointTag
        {
        ...
        public override bool IsSubscribed
        {
            get
            {
                bool trackingBool = true;
                foreach (KeyValuePair<string, SubscriptionTrackingObject> item in SubscriptionTracker)
                {
        ...
        public override void ParseSubscriptionMessage(string customName, string value)
        {
            ...
            {
                double localValue = double.Parse(value);
        ...
        {
            TesiraFaderJoinMapAdvanceeStandalone joinMap = new TesiraFaderJoinMapAdvanceeStandalone(joinStart);
            ...
            trilist.SetSigFalseAction(joinMap.EnableLevelSend.JoinNumber, () =>
            {
                ...
                genericChannel.SetVolume(trilist.UShortOutput[joinMap.Volume.JoinNumber].UShortValue);
            });

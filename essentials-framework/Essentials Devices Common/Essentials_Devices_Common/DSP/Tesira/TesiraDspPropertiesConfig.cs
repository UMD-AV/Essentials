...
namespace Tesira_DSP_EPI
{
    public class TesiraDspPropertiesConfig
    {
        ...
        [JsonProperty("presets")] public Dictionary<string, TesiraDspPresets> Presets { get; set; }
        ...
        [JsonProperty("resubscribeString")] public string ResubscribeString { get; set; }
    }
    ...
    public class TesiraFaderControlBlockConfig
    {
        ...
        [JsonProperty("index1")] public int Index1 { get; set; }

        [JsonProperty("index2")] public int Index2 { get; set; }
        ...
        [JsonProperty("incrementAmount")] public string IncrementAmount { get; set; }

        [JsonProperty("permissions")] public int Permissions { get; set; }

        [JsonProperty("bridgeIndex")] public uint? BridgeIndex { get; set; }
    }
    ...
    public class TesiraDialerControlBlockConfig
    {
        ...
        [JsonProperty("isVoip")] public bool IsVoip { get; set; }

        [JsonProperty("label")] public string Label { get; set; }

        [JsonProperty("displayNumber")] public string DisplayNumber { get; set; }

        [JsonProperty("dialerInstanceTag")] public string DialerInstanceTag { get; set; }
        ...
        [JsonProperty("callAppearance")] public int CallAppearance { get; set; }

        [JsonProperty("clearOnHangup")] public bool ClearOnHangup { get; set; }

        [JsonProperty("appendDtmf")] public bool AppendDtmf { get; set; }
    ...
    public class TesiraSwitcherControlBlockConfig
    {
        ...
        [JsonProperty("switcherInstanceTag")] public string SwitcherInstanceTag { get; set; }

        [JsonProperty("index1")] public int Index1 { get; set; }

        [JsonProperty("bridgeIndex")] public uint? BridgeIndex { get; set; }

        [JsonProperty("switcherInputs")] public Dictionary<uint, RoutingPort> SwitcherInputs { get; set; }

        [JsonProperty("switcherOutputs")] public Dictionary<uint, RoutingPort> SwitcherOutputs { get; set; }
    ...
    public class TesiraRouterControlBlockConfig
    {
        ...
        [JsonProperty("routerInstanceTag")] public string RouterInstanceTag { get; set; }

        [JsonProperty("index1")] public int Index1 { get; set; }

        [JsonProperty("routerInputs")] public Dictionary<uint, RoutingPort> RouterInputs { get; set; }

        [JsonProperty("routerOutput")] public RoutingPort RouterOutput { get; set; }
    ...
    public class TesiraSourceSelectorControlBlockConfig
    {
        ...
        [JsonProperty("sourceSelectorInputs")] public Dictionary<uint, RoutingPort> SourceSelectorInputs { get; set; }

        [JsonProperty("sourceSelectorOutput")] public RoutingPort SourceSelectorOutput { get; set; }
    ...
    public class TesiraStateControlBlockConfig
    {
        ...
        [JsonProperty("stateInstanceTag")] public string StateInstanceTag { get; set; }
    ...
    public class TesiraDspPresets
    {
        ...
        [JsonProperty("presetId")] public int PresetId { get; set; }

        [JsonProperty("presetIndex")] public int PresetIndex { get; set; }
    ...
    public class TesiraMeterBlockConfig
    {
        ...
        [JsonProperty("meterInstanceTag")] public string MeterInstanceTag { get; set; }

        [JsonProperty("index")] public int Index { get; set; }

        [JsonProperty("meterData")] public MeterMetadata MeterData { get; set; }
    ...
    {
        [JsonProperty("meterMinimum")] public double MeterMimimum { get; set; }

        [JsonProperty("meterMaximum")] public double MeterMaxiumum { get; set; }

        [JsonProperty("defaultPollTime")] public int DefaultPollTime { get; set; }
    }
    ...
    public class TesiraCrosspointStateBlockConfig
    {
        ...
        [JsonProperty("matrixInstanceTag")] public string MatrixInstanceTag { get; set; }
        ...
        [JsonProperty("pollEnable")] public bool PollEnable { get; set; }
    ...
    public class TesiraRoomCombinerBlockConfig
    {
        ...
        [JsonProperty("roomIndex")] public int RoomIndex { get; set; }

        [JsonProperty("isMic")] public bool IsMic { get; set; }

        [JsonProperty("useAbsoluteValue")] public bool UseAbsoluteValue { get; set; }

        [JsonProperty("umuteOnVolChange")] public bool UnmuteOnVolChange { get; set; }

        [JsonProperty("incerementAmount")] public string IncrementAmount { get; set; }

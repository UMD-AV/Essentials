...
namespace Tesira_DSP_EPI
{
    ...
    public class TesiraDspMeter : TesiraDspControlPoint
    {
                ...
                string.Format(KeyFormatter, parent.Key, key), config.Label, config.BridgeIndex)
        {
            ...
            {
                MeterMetadata data = config.MeterData;
        ...
        public override void ParseSubscriptionMessage(string customName, string message)
        {
            ...
            double value = double.Parse(message)
                .Scale(_meterMinimum, _meterMaximum, ushort.MinValue, ushort.MaxValue, this);
        ...
        {
            TesiraMeterJoinMapAdvancedStandalone joinMap = new TesiraMeterJoinMapAdvancedStandalone(joinStart);

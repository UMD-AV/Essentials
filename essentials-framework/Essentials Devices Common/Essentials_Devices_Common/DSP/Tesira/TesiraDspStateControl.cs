...
namespace Tesira_DSP_EPI
{
    public class TesiraDspStateControl : TesiraDspControlPoint, IPrivacy
    {
        ...
        public TesiraDspStateControl(string key, TesiraStateControlBlockConfig config, TesiraDsp parent)
            : base(config.StateInstanceTag, config.SubscriptionInstanceTag, config.Index, 0, parent,
        ...
        {
            TesiraStateJoinMapAdvancedStandalone joinMap = new TesiraStateJoinMapAdvancedStandalone(joinStart);

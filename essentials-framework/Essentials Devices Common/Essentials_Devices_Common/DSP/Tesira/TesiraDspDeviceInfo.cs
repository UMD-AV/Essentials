...
namespace Tesira_DSP_EPI
{
    public class TesiraDspDeviceInfo : TesiraDspControlPoint, IDeviceInfoProvider
    {
        ...
        public TesiraDspDeviceInfo(TesiraDsp parent)
            : base("DEVICE", "DEVICE", 0, 0, parent, string.Format(KeyFormatter, parent.Key, "DeviceInfo"),
                "DeviceInfo", 0)
        {
            ...
            switch (attributeCode)
            {
                case ("networkStatus"):
                {
                    ...
                    DeviceInfo.MacAddress =
                        string.IsNullOrEmpty(DeviceInfo.MacAddress) ? MacAddress : DeviceInfo.MacAddress;
                    DeviceInfo.IpAddress =
                        string.IsNullOrEmpty(DeviceInfo.IpAddress) ? IpAddress : DeviceInfo.IpAddress;
        ...
        {
            TesiraDspDeviceJoinMapAdvancedStandalone joinMap = new TesiraDspDeviceJoinMapAdvancedStandalone(joinStart);
            ...
            Parent.CommunicationMonitor.IsOnlineFeedback.LinkInputSig(
        ...
        {
            DeviceInfoEventArgs args = new DeviceInfoEventArgs(DeviceInfo);

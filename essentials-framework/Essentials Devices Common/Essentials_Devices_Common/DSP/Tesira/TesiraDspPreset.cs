...
namespace Tesira_DSP_EPI
{
    public class TesiraDspPresetDevice : TesiraDspControlPoint, IHasDspPresets
    {
        ...
        {
            TesiraPresetJoinMapAdvancedStandalone presetJoinMap = new TesiraPresetJoinMapAdvancedStandalone(joinStart);
            ...
            foreach (IDspPreset preset in Presets)
            {
                ...
                trilist.StringInput[(uint)(presetJoinMap.PresetNameFeedback.JoinNumber + presetIndex - 1)].StringValue =
    ...
    public class TesiraPreset : TesiraDspPresets, IDspPreset
    {
        ...
        public TesiraPreset(TesiraDspPresets data)
        {
            ...
            Debug.Console(1, "Tesira PresetData = {0} , {1}, {2}", PresetData.PresetName, PresetData.PresetId,

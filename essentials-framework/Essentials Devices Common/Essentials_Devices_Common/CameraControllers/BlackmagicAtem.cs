...
namespace PepperDash.Essentials.Devices.Common.ImageProcessors
{
    public class BlackmagicAtem : EssentialsBridgeableDevice, IBridgeAdvanced, ICommunicationMonitor
    {
        ...
        public override void LinkToApi(BasicTriList trilist, uint joinStart, string joinMapKey, EiscApiAdvanced bridge)
        {
            ...
            for (uint x = 0; x < numberOutputs; x++)
            {
                ...
                OutputRouteNameFeedbacks[x + 1]
                    .LinkInputSig(trilist.StringInput[joinMap.OutputCurrentInputNames.JoinNumber + x]);
            }
        }
    ...
    public class BlackmagicAtemJoinMap : JoinMapBaseAdvanced
    {
        ...
        [JoinName("OutputSource")] public JoinDataComplete OutputSource = new JoinDataComplete(
            new JoinData { JoinNumber = 101, JoinSpan = 4 },
            new JoinMetadata
            {
                Description = "Switcher Output Source Set / Get", JoinCapabilities = eJoinCapabilities.ToFromSIMPL,
        ...
        [JoinName("OutputCurrentInputNames")] public JoinDataComplete OutputCurrentInputNames = new JoinDataComplete(
            ...
            new JoinMetadata
            {
                Description = "Switcher Output Currently Routed Input Name",

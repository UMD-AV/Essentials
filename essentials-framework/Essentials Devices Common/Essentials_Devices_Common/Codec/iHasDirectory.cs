...
namespace PepperDash.Essentials.Devices.Common.Codec
{
    ...
    public class CodecDirectory
    {
        ...
        {
            get { return CurrentDirectoryResults.OfType<DirectoryContact>().Cast<DirectoryItem>().ToList(); }
        }

        [JsonProperty("folders")]
        public List<DirectoryItem> Folders
        {
            get { return CurrentDirectoryResults.OfType<DirectoryFolder>().Cast<DirectoryItem>().ToList(); }
        }
        ...
        {
            List<DirectoryItem> sortedFolders = new List<DirectoryItem>();

            sortedFolders.AddRange(CurrentDirectoryResults.Where(f => f is DirectoryFolder));

            sortedFolders.OrderBy(f => f.Name);

            List<DirectoryItem> sortedContacts = new List<DirectoryItem>();
    ...
    public class InvitableDirectoryContact : DirectoryContact, IInvitableContact
    {
        ...
        {
            get { return this is IInvitableContact; }
        }
    }
    ...
    public class DirectoryItem : ICloneable
    {
        ...
        [JsonProperty("parentFolderId")] public string ParentFolderId { get; set; }
    }
    ...
    {
        [JsonProperty("contacts")] public List<DirectoryContact> Contacts { get; set; }
    ...
    public class DirectoryContact : DirectoryItem
    {
        ...
        [JsonProperty("contactMethods")] public List<ContactMethod> ContactMethods { get; set; }
    ...
    {
        [JsonProperty("contactMethodId")] public string ContactMethodId { get; set; }

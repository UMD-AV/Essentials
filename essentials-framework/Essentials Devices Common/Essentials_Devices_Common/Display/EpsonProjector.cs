...
namespace PepperDash.Essentials.Devices.Displays
{
        ...
        IHasLampHours, IHasErrorString, IDisposable
    {
        ...
        public void LinkToApi(BasicTriList trilist, uint joinStart, string joinMapKey, EiscApiAdvanced bridge)
        {
            ...
            EpsonProjectorJoinMap joinMap = new EpsonProjectorJoinMap(joinStart);
                    ...
                    for (int startPos = 0; startPos + _tcpHeader.Length < e.Bytes.Length; startPos++)
                    {
                        ...
                        while (e.Bytes[startPos + headerPos] == _tcpHeader[headerPos])
                        {
                            ...
                            if (headerPos == _tcpHeader.Length)
                            {
                                ...
                                Debug.Console(1, this, "EpsonProjector tcp status code: {0}",
                                    string.Format(@"[{0:X2}]", (int)statusCode));
                                if (statusCode == 0x20)
                                {
                ...
                if (data.Length > 1)
                {
                    if (data[0].EndsWith("PWR"))
                    {
                        if (data[1] == "01")
                        {
                            ...
                            if (_abnormalStandby) _abnormalStandby = false;
                    ...
                    else if (data[0].EndsWith("VOL"))
                    {
                        ...
                        if (newVol > 0) _savedVolumeForMute = newVol;
                        ...
                        if (_RequestedVolume == newVol) _RequestedVolume = null;
        ...
        {
            if (_RequestedVideoMuteState == 2) VideoMuteOffGo();

            if (_RequestedInputState != 0) InputSelectGo(_RequestedInputState);

            if (_RequestedVolume != null) SetVolumeRaw((ushort)_RequestedVolume);
        }
        ...
        public void SendCommand(eCommandType type, string cmd, bool priority)
        {
            if (_readyForCommands)
            {
                ...
                {
                    if (_volumeQueue.Count > 5) _volumeQueue.ClearQueue();
        ...
        public void StatusGet()
        {
            if (_readyForCommands)
            {
                ...
                if (_PowerIsOn && !_IsWarmingUp)
                {
                    ...
                    if (_hdmiBlanking == null) VideoMuteGet();
        ...
        public void VideoMuteOff()
        {
            ...
            else
            {
                ...
                if (_PowerIsOn && !_IsWarmingUp) VideoMuteOffGo();
            }
        }
        ...
        public void InputNetwork()
        {
            ...
            {
                RequestInput(3);
                if (!_IsWarmingUp) InputNetworkGo();
            }
        }
        ...
        private class EpsonQueue
        {
            ...
            public void AddOrUpdateCommand(KeyValuePair<eCommandType, string> command)
            {
                ...
                try
                {
                    ...
                    else if (i != -1 && (command.Key == eCommandType.InputPoll ||
                                         command.Key == eCommandType.LampPoll ||
                                         command.Key == eCommandType.ErrorPoll ||
                                         command.Key == eCommandType.PowerPoll ||
        ...
        public void VolumeDown(bool pressRelease)
        {
            ...
            if (pressRelease) CrestronInvoke.BeginInvoke((o) => VolumeDownLoop());
        }
        ...
        public void VolumeUp(bool pressRelease)
        {
            ...
            if (pressRelease) CrestronInvoke.BeginInvoke((o) => VolumeUpLoop());
        }
    ...
    public class EpsonProjectorJoinMap : DisplayControllerJoinMap
    {
        ...
        [JoinName("ErrorMessage")] public readonly JoinDataComplete ErrorMessage = new JoinDataComplete(
            ...
            new JoinMetadata
            {
                Description = "Error Message Feedback", JoinCapabilities = eJoinCapabilities.ToSIMPL,
    ...
    public class EpsonProjectorFactory : EssentialsDeviceFactory<EpsonProjector>
    {
        ...
        public override EssentialsDevice BuildDevice(DeviceConfig dc)
        {
            ...
            EpsonProjectorPropertiesConfig config = dc.Properties.ToObject<EpsonProjectorPropertiesConfig>();
    ...
    public class EpsonProjectorPropertiesConfig
    {
        ...
        [JsonProperty("volumeSteps")] public int? volumeSteps { get; set; }

...
namespace Epi.Display.Lg
{
        ...
        IBridgeAdvanced
    {
            ...
            : base(key, name)
        {
            ...
            LgDisplayPropertiesConfig props = config;
            if (props == null)
            {
        ...
        private void Init()
        {
            ...
            {
                double scaleUpper = NumericalHelpers.Scale(_upperLimit, 0, 100, 0, 65535);
                double scaleLower = NumericalHelpers.Scale(_lowerLimit, 0, 100, 0, 65535);
            ...
            AddRoutingInputPort(
                new RoutingInputPort(RoutingPortNames.DisplayPortIn,
        ...
        {
            string[] data = s.Trim().Replace("OK", "").Split(' ');
        ...
        {
            RoutingInputPort newInput = InputPorts.FirstOrDefault(i => i.FeedbackMatchObject.Equals(s.ToLower()));

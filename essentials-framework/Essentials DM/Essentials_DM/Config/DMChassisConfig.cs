...
namespace PepperDash.Essentials.DM.Config
{
    ...
    public class DMChassisPropertiesConfig
    {
        ...
        [JsonProperty("inputSlots")] public Dictionary<uint, string> InputSlots { get; set; }

        [JsonProperty("outputSlots")] public Dictionary<uint, string> OutputSlots { get; set; }
    ...
    {
        [JsonProperty("outLevel")] public int OutLevel { get; set; }

        [JsonProperty("isVolumeControlPoint")] public bool IsVolumeControlPoint { get; set; }
    }
}